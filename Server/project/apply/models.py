...
class Case(models.Model):
    ...
    wishDate = models.CharField(max_length=20)
    address = models.CharField(max_length=100)
    addressLatitude = models.FloatField(default=0.0)
    addressLongitude = models.FloatField(default=0.0)
    addressCounty = models.CharField(max_length=10)
    addressDistrict = models.CharField(max_length=10)
    ...
    buildingAge = models.CharField(max_length=20)
    buildingType = models.CharField(max_length=20)
    buildingFloors = models.CharField(max_length=20, default='1')
